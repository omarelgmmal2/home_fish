...
class HallAllItemsScreen extends StatefulWidget {
  const HallAllItemsScreen({super.key});

  @override
  State<HallAllItemsScreen> createState() => _MainScreenState();
}

class _MainScreenState extends State<HallAllItemsScreen> {
  bool isLoading = true;
  int? selectedIndex;
